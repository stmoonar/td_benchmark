"""c3 dataflow: group128 quant -> ll-a2a FP8 dispatch + FP8 GroupGEMM -> combine."""
...
SPEC = SchemeSpec("c3", "TD-EP-FP8", "td_fused", "EP", "group128 quant -> ll-a2a FP8 dispatch+GroupGEMM -> combine", "fp8", "group128", True, FP8_EP_TUNABLES)
