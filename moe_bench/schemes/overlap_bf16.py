"""b1 dataflow: chunk AG(bf16) || GEMM -> chunk RS(bf16)."""
...
SPEC = SchemeSpec(
    ...
    parallel="TP",
    comm="chunk AG(bf16) || GEMM -> chunk RS(bf16)",
    weight_dtype="fp8",
    act_quant="group128",
...
def build(cfg: Any, ctx: Any, data: Any, scheme_cfg: Any) -> SchemeInstance:
    return build_overlap_instance(SPEC, "moe_forward_overlap", cfg, ctx, data, scheme_cfg)
